...
print('rank, name, profit, rewards, btc')
for item in coin_items[0:10]:
    print('{:2d}, {}, {}, {:7.5f}, {:9.4f}'.format(item['rank'], item['name'].ljust(20), item['effective_profit'], item['btc_24h'], item['rewards_24h']))
