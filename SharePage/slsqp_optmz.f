...
C     iteration was inconsistent or not.
      ...
      WRITE(*, *) 'slsqb func - mode : ', mode
      WRITE(*, *) 'slsqb func - x    : ', x
      WRITE(*, *) 'slsqb func - s    : ', s
      IF (mode) 260, 100, 220

  100 WRITE(*, *) 'Section 100'
      itermx = iter
      IF (acc.GE.ZERO) THEN
          iexact = 0
      ELSE
...
C   SEARCH DIRECTION AS SOLUTION OF QP - SUBPROBLEM
      ...
      WRITE(*, *) 'slsqb func:130 - mode: ', mode
      WRITE(*, *) 'slsqb func:130 - x : ', x
      WRITE(*, *) 'slsqb func:130 - s : ', s
...
C   even if the augmented problem was solved.
  ...
  140     WRITE(*, *) 'Section 140'
          ...
          v(n1) = one
          incons = 0
  150     WRITE(*, *) 'Section 150'
          CALL lsq (m, meq, n1, n3, la, l, g, a, c, u, v, s, r,
     *              w, iw, mode)
          h4 = one - s(n1)
          IF (mode.EQ.4) THEN
              l(n3) = ten*l(n3)
...
C   INEXACT LINESEARCH
  ...
  190     WRITE(*, *) 'Section 190'
          line = line + 1
          h3 = alpha*h3
          WRITE(*, *) 'slsqb func:190:before_dscal_sl - s: ',s
          CALL dscal_sl(n, alpha, s, 1)
          WRITE(*, *) 'slsqb func:190:after_dscal_sl - s: ',s
          CALL dcopy_(n, x0, 1, x, 1)
          WRITE(*, *) 'slsqb func:190:before_daxpy_sl - s: ', s
          WRITE(*, *) 'slsqb func:190:before_daxpy_sl - x: ', x
          WRITE(*, *) 'slsqb func:190:before_daxpy_sl - n: ', n
          WRITE(*, *) 'slsqb func:190:before_daxpy_sl - alpha: ', alpha
          CALL daxpy_sl(n, one, s, 1, x, 1)
          WRITE(*, *) 'slsqb func:190:after_daxpy_sl - s: ', s
          WRITE(*, *) 'slsqb func:190:after_daxpy_sl - x: ', x
          WRITE(*, *) 'slsqb func:190:after_daxpy_sl - n: ', n
          WRITE(*, *) 'slsqb func:190:after_daxpy_sl - alpha: ', alpha
          mode = 1
          GO TO 330
  200         WRITE(*, *) 'Section 200'
              IF (h1.LE.h3/ten .OR. line.GT.10) GO TO 240
              alpha = MAX(h3/(two*(h3-h1)),alfmin)
              GO TO 190

C   EXACT LINESEARCH

  210 WRITE(*, *) 'Section 210'
      IF (line.NE.3) THEN
...
C   UPDATE CHOLESKY-FACTORS OF HESSIAN MATRIX BY MODIFIED BFGS FORMULA
  ...
  260 WRITE(*, *) 'Section 260'
      DO 270 i=1,n
         u(i) = g(i) - ddot_sl(m,a(1,i),1,r,1) - v(i)
  270 WRITE(*, *) 'Section 270'
      CONTINUE
...
C   L'*S
      ...
      DO 290 i=1,n
         ...
         DO 280 j=i+1,n
            k = k + 1
            h1 = h1 + l(k)*s(j)
  280    WRITE(*, *) 'Section 280'
         CONTINUE
         v(i) = s(i) + h1
  290 WRITE(*, *) 'Section 290'
      CONTINUE
...
C   L*D*L'*S
      ...
      DO 320 i=n,1,-1
         ...
         DO 310 j=1,i - 1
            h1 = h1 + l(k)*v(j)
            k = k + n - j
  310    WRITE(*, *) 'Section 310'
         CONTINUE
         v(i) = v(i) + h1
  320 WRITE(*, *) 'Section 320'
      CONTINUE
...
C     CALL       lsq(m,meq,n,n3,la,l,g,a,c,u, v, s,r,w,iw, mode)
...
C     CALL       lsei(w(ic), w(id), w(ie), w(IF), w(ig), w(ih), MAX(1,meq),
C     .           meq, n, n, m1, m1-nancnt, n, x, xnorm, w(iw), jw, mode)
...
C               4: INEQUALITY CONSTRAINTS INCOMPATIBLE
     ...
     .                 ZERO,one,fac,rnorm,dnrm2_,ddot_sl,diff,tmp
...
C  COMPUTE SOLUTION OF PRIMAL PROBLEM
      ...
      IF (ISNAN(fac)) THEN
          ...
          GOTO 50
      ENDIF
      WRITE(*, *) 'ldp func - fac: ', fac
      IF(diff(one+fac,one).LE.ZERO) GOTO 50
      mode=1
      fac=one/fac
      DO 40 j=1,n
          WRITE(*, *) 'ldp func - ddot_sl: ', tmp
...
C     CALL daxpy_sl(n, one, s, 1, x, 1)

      DOUBLE PRECISION dx(*),dy(*),da
      INTEGER i,incx,incy,ix,iy,m,mp1,n

      WRITE(*, *) 'daxpy_sl func - n, da, incx, incy: ', n, da, incx, incy
...
C        NOT EQUAL TO 1
      ...
      WRITE(*, *) 'daxpy_sl func - incx, incy: ', incx, incy
      WRITE(*, *) 'daxpy_sl func - ix, iy: ', ix, iy
      DO 10 i = 1,n
